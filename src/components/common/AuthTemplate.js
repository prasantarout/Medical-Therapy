...
const AuthTemplate = props => {
  ...
  return (
    <SafeAreaView
      style={[css.f1, {backgroundColor: colors.bgColor}, props.style]}>
      <KeyboardAvoidingView behavior={props?.behavior}>
          ...
          <View style={[css.f1, css.asc]}>
            <View style={[]}>
              <View style={[css.aic, css.jcc]}>
                ...
                <Txt style={[styles.subHeaderText, css.mt5]}>
                  {props?.subtitle}
                </Txt>
              </View>
            </View>
            <View style={[css.f1, css.py11]}>{props?.children}</View>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
    </SafeAreaView>
