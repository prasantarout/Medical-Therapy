...
const MyPatient = (props) => {
  ...
  console.log("myPatientt", patientInfo)
  // useEffect(() => {
  ...
  const sortFunction = (value) => {
    if (value === "New") {
      const sortedPatients = [...patientInfo].sort((a, b) => new Date(b.setupDate) - new Date(a.setupDate));
      setPatientInfo(sortedPatients);
    } else if (value === "Repeated") {
      const sortedPatients = [...patientInfo].sort((a, b) => new Date(a.setupDate) - new Date(b.setupDate));
      setPatientInfo(sortedPatients);
    }
  }
    ...
    <>
      ...
      <Modal
        ...
        <View style={[css.f1, css.center, styles.backdrop]}>
          <View
            style={[styles.modalStyle, { maxWidth: width - normalize(16) }]}>
            <TouchableOpacity
            ...
            <View style={[css.row, css.mt1]}>
              ...
              <View style={[css.ml5, css.jcc]}>
                ...
                <Modalinfo title="Phone No.:" value={modalInfo?.phone ? modalInfo?.phone : "N/A"} />
                <Divider style={[styles.dividerGap]} />
                <Modalinfo
                  title="Email Address:"
                ...
                />
                <Divider style={[styles.dividerGap]} />
                <Modalinfo title="Date:" value={moment(modalInfo?.created_at).format('YYYY-MM-DD')} />
                <Divider style={[styles.dividerGap]} />
                <Modalinfo title="Time:" value={moment(modalInfo?.created_at).format('hh:mm A')} />
              </View>
            </View>
          </View>
        </View>
