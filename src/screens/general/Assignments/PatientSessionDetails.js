        ...
        return (
            <View style={[css.mt1]} >
                <View style={[css.row, css.aic]} >
                    ...
                    <Txt style={[css.fs17, css.ml1, css.textPrimary, css.medium]} >{title}</Txt>
                    <Txt style={[css.fs15, css.ml1, css.textLighte, valueStyle]} >{value}</Txt>
                </View>
            </View>
        )
    }
                ...
                <View style={[css.mt3, css.card]} >
                    ...
                    <View style={[css.mt2, css.w60, css.fw]} >
                        <View style={[css.row, css.aic, styles.iconTextContainer]} >
                            <Image source={{ uri: item?.profile_photo_url }} style={[styles.userIconStyle]} />
                            <View>
                                <Txt style={[css.fs18, css.semiBold, css.ml1]} >{item?.patient_name}</Txt>
                                <View style={[css.row, css.aic, styles.iconTextContainer, css.ml1]} >
                    ...
                    <View style={[css.mt5]} >
                        ...
                        <Txt style={[css.fs18, css.semiBold]} >Target inhalation positive airway pressure(in cmH2O)</Txt>
                        <View style={[css.row, css.aic, css.fw]} >
                            <InternalListBlock
                        ...
                        <Txt style={[css.fs18, css.semiBold, css.mt2]} >Target exhalation positive airway pressure(in cmH2O)</Txt>
                        <View style={[css.row, css.aic, css.fw]} >
                            <InternalListBlock
                                title="95% of target IPAP"
                        ...
                        <Txt style={[css.fs18, css.semiBold, css.mt2]} >Leak metrics(in liters per second)</Txt>
                        <View style={[css.row, css.aic, css.fw]} >
                            <InternalListBlock
                                title="95% of target IPAP"
                        ...
                        <Txt style={[css.fs18, css.semiBold, css.mt2]} >Respiratory rate metrics(in cmH2O)</Txt>
                        <View style={[css.row, css.aic, css.fw]} >
                            <InternalListBlock
                                title="95% of target IPAP"
                        ...
                        <Txt style={[css.fs18, css.semiBold, css.mt2]} >ieRatio metrics (inhalation:exhalation ratio)</Txt>
                        <View style={[css.row, css.aic, css.fw]} >
                            <InternalListBlock
                                title="95% of target IPAP"
                        ...
                        <Txt style={[css.fs18, css.semiBold, css.mt2]} >Minute ventilation metrics(in liters per minute)</Txt>
                        <View style={[css.row, css.aic, css.fw]} >
                            <InternalListBlock
                                title="95% of target IPAP"
                        ...
                        <Txt style={[css.fs18, css.semiBold, css.mt2]} >Tidal volume metrics(in liters)</Txt>
                        <View style={[css.row, css.aic, css.fw]} >
                            <InternalListBlock
                                title="95% of target IPAP"
